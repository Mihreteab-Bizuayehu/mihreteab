            ...
            <div className="flex flex-col items-center sm:w-1/2 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg transition hover:scale-[1.02]">
              ...
              <ul className="w-full grid grid-cols-2 sm:grid-cols-3 gap-4">
                {iconsConfig.programmingLanguages.map((item, index) => (
                  <li
                    key={index}
                    className=" px-3 py-2 bg-gray-200 rounded-md dark:bg-gray-700 flex items-center justify-start gap-2 text-base font-medium text-gray-800 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition"
                  >
            ...
            <div className="flex flex-col items-center sm:w-1/2 bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg transition hover:scale-[1.02]">
              ...
              <ul className="w-full grid grid-cols-2 sm:grid-cols-3 gap-4">
                {iconsConfig.webTechnologies.map((item, index) => (
                  <li
                    key={index}
                    className=" px-3 py-2 bg-gray-200 rounded-md dark:bg-gray-700 flex items-center justify-start gap-2 text-base font-medium text-gray-800 dark:text-gray-200 hover:text-indigo-600 dark:hover:text-indigo-400 transition"
                  >
                    <span className="text-xl">{item.icon}</span>
                    {item.label}
                  </li>
